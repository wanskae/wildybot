...
module.exports = async (client, message, Discord, args) => {
    ...
    .setTitle('YLEISTIETOA ROOLEISTA')
    .setColor('0xd62075')
    .setDescription('<@&235483050845143040>: Serverin ylläpitäjät.\n'
        ...
        + `<@&318411726230126613>: Tämä rooli on varattu erityisille ihmisille.\n`
        ...
        + `<@&803364819830702080>: Rooli niille, jotka haluavat ilmoituksia puhekanavalla järjestettävästä iltasadusta.\n\n`
